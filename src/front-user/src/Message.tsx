          ...
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              ...
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-sm/6 font-semibold text-indigo-600">Beta Launching</h2>
                </div>
              ...
              A microservices-driven cloud platform for ultra-secure, stable, and scalable file transfers – built for tomorrow’s demands.
              </p>
